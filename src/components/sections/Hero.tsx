    ...
    <section className="relative min-h-[68vh] lg:min-h-screen flex flex-col justify-center pt-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-24 w-full">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-16 items-center">
          <div className="space-y-6 order-1 lg:order-1 animate-fade-in-up">
            ...
            <p className="text-lg sm:text-xl text-white/60 max-w-xl leading-relaxed text-balance">
              Un workshop de 6 horas para entender cómo usar IA en la práctica, identificar oportunidades reales y construir sistemas que funcionen con datos, lógica y criterio.
            </p>

            <p className="text-base text-white/80 font-medium max-w-xl leading-relaxed">
              No es una clase de teoría. Vas a ver cómo se decide, se diseña, se conecta y se ejecuta una solución real, paso a paso, con acompañamiento y decisiones concretas.
            </p>
          ...
          <div className="relative order-2 lg:order-2 animate-fade-in">
            <div className="relative ml-auto max-w-[520px]">
              <div className="absolute -top-8 -left-6 z-10 w-40 sm:w-48 lg:w-52 overflow-hidden rounded-2xl border border-white/10 shadow-2xl shadow-black/40">
                <Image
                  src="/images/potencia-argentina.jpg"
                  alt="Potencia Argentina"
                  width={420}
                  height={320}
                  className="h-28 sm:h-32 lg:h-36 w-full object-cover"
                />
              </div>
